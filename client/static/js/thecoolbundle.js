  ...
  var Page = {  
      ...
      WindowChanged: function() {
        ...
        var bodyW = document.documentElement.clientWidth,
            ...
            newUnitW = (bodyW - (bodyW % 80)) / 1600,
            newUnitH = (bodyH - (bodyH % 100)) / 2000,
      ...
      Initialize: function(){
        ...
        if (this.IsSetup === false){
          ...
          tetrisDiv.appendChild(Page.cvs);
  
          this.cvs.style.position = 'absolute'; 
          this.cvs.style.marginTop = '500px';
...
function submitHighscore(e){
    ...
    const highscoreData = {
        score: e.target.addscoreinput.value,
        game: 'Tetris',
...
function appendHighScore (highScoreData) {
